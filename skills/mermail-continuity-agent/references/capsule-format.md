...
```
capsule/v1 · agent=<agent name> · session=<session identifier or "unknown"> · prev=<emailId of the previous capsule, or "none">
```
...
Default ceiling: 4,000 characters. A capsule that needs more is usually carrying a chronicle; move the chronicle to where chronicles live and keep the capsule as a map.

## Example

```
capsule/v1 · agent=aurora · session=b43c6f14 · prev=7f3a9c12-…
