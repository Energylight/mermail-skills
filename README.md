...
| `mermail-continuity-agent` | Give an agent continuity across sessions: wake from a self-addressed capsule thread, recall past decisions by quote, and hand off the next capsule to the agent's own address |
